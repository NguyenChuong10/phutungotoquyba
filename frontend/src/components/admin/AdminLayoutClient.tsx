  ...
  return (
    <AdminNotificationProvider>
      <AdminSidebarProvider>
        <div className="h-screen max-h-screen bg-slate-50 text-slate-900 flex font-sans antialiased relative overflow-hidden" suppressHydrationWarning>
          <AdminSidebar />
          <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden" suppressHydrationWarning>
            <AdminHeader />
